...
public class MainActivity extends AppCompatActivity {
    ...
    private void fetchBooksData(String query) {
        ...
        bookApiCall.enqueue(new Callback<BookDetailsContainer>() {
            ...
            public void onResponse(Call<BookDetailsContainer> call, Response<BookDetailsContainer> response) {
                setupBookListView((List<Book>)(Object) response.body().getBookList());
            }

            @Override
            public void onFailure(Call<BookDetailsContainer> call, Throwable t) {
                Snackbar.make(findViewById(R.id.recyclerview), "Something went wrong... Please try later!",
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(BookDetailsActivity.EXTRA_BOOK_POSITION, books.indexOf(book));
