...
class Builder {
    ...
    protected int x = 4, y = 4;
    protected ArrayList<Segment> plansza;
    public Builder() { plansza = new ArrayList<>(); }
    public void addX(int liczba) {
        x += liczba * TILESIZE;
    }
    public void addA(int liczba) {
    ...
    public void newLine() { x = 4; y += TILESIZE; }
    public ArrayList<Segment> dajPlansze() { return plansza; }
}

class BuilderSecond extends Builder {
    public void addC(int liczba) {
        for (int i=0;i<liczba;++i) {
...
class Game extends JPanel {
    ...
    private ArrayList<Segment> stworzPlansze(String plik, Builder b) {
    ...
    public Game(String plik) {
        ...
        setFocusable(true);
        plansza=stworzPlansze(plik, new BuilderSecond());
