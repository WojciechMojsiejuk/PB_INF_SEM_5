...
class Game extends JPanel {
    ...
    private ArrayList<Segment> stworzPlansze(String plik, Builder builder) {
        ...
        try {
            ...
            while ((linia=br.readLine())!=null)
            {
                ...
                while ((linia.length()-znaki)>=3)
                {
                    ...
                    {
                        case 'X':
                            builder.CreateSegmentX(liczba);
                            break;
                        case 'A':
                            builder.CreateSegmentA(liczba);
                            break;
                        case 'B':
                            builder.CreateSegmentB(liczba);
                            break;
                        case 'C':
                            builder.CreateSegmentC(liczba);
                            break;
                        case 'G':
                            builder.CreateSegmentG(liczba);
                            break;
                    }
                }
                builder.CreateNewLine();
            }
            br.close();
            return builder.plansza;
        } catch (IOException e) {
    ...
    public Game(String plik) {
        ...
        setFocusable(true);
        plansza=stworzPlansze(plik, new Builder2());
...
abstract class Builder
{
    ...
    protected int x = 4;
    protected int y = 0;
    public ArrayList<Segment> plansza=new ArrayList<Segment>();
    public void CreateSegmentA(int ileRazy)
    {
    ...
    public void CreateSegmentB(int ileRazy)
    {
        for(int i=0;i<ileRazy;i++){
    ...
    public void CreateSegmentC(int ileRazy){
        for(int i=0;i<ileRazy;i++){
    ...
    public void CreateSegmentG(int ileRazy){
        for(int i=0;i<ileRazy;i++){
    ...
    public void CreateSegmentX(int ileRazy)
    {
        x+=ileRazy*TILESIZE;
    }
