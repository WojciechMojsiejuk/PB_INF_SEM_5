...
public class Chessboard extends JPanel {
	...
	Chessboard() {
		...
		board.put(new Point(0, 2), new DecoratorPiece(new Piece(11, 0, 2), tr));
		board.put(new Point(0, 6), new DecoratorPiece(new Piece(0, 0, 6), tr));
		board.put(new Point(1, 5), new DecoratorPiece(new Piece(5, 1, 5), tr));
		board.put(new Point(3, 7), new DecoratorPiece(new Piece(1, 3, 7), tr));
		board.put(new Point(1, 4), new DecoratorPiece(new Piece(6, 1, 4), tr));
		board.put(new Point(4, 3), new DecoratorPiece(new Piece(6, 4, 3), tr));
		board.put(new Point(4, 4), new DecoratorPiece(new Piece(7, 4, 4), tr));
		board.put(new Point(5, 4), new DecoratorPiece(new Piece(6, 5, 4), tr));
		board.put(new Point(5, 6), new DecoratorPiece(new Piece(0, 5, 6), tr));
		board.put(new Point(6, 5), new DecoratorPiece(new Piece(0, 6, 5), tr));
		board.put(new Point(7, 4), new DecoratorPiece(new Piece(0, 7, 4), tr));
